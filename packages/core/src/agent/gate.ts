...
// `Options.web.fetch.blockedDomains` (`runtime-sdk/mode-options.ts`'s `webOptionsFor`, from the same
...
// (once the retired engine's `webFetchGate`; today `Options.web.fetch.blockedDomains` inside the child
